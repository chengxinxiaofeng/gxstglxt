	...
	<body>
		<form class="layui-form form1" >
                ...
                <div class="layui-inline" style="width:100%;margin-top:15px;" >
                  ...
                  <div class="layui-input-inline">
                    <input type="tel" name="association_name" id="association_name" lay-verify="email" autocomplete="off" class="layui-input" style="width:200px;"  disabled="disabled">
                  </div>
                </div>
                <div class="layui-inline" style="width:100%;margin-top:15px;" >
                  <label class="layui-form-label">成立时间：</label>
                  <div class="layui-input-inline">
                    <input type="tel" name="starttime" id="starttime" lay-verify="email" autocomplete="off" class="layui-input" style="width:200px;"  disabled="disabled">
                  </div>
                </div>               
          </form>
...
function fnSetMsg(){
		...
		$("#association_name").val(associationInfoMap.ASSOCIATION_NAME);
		$("#starttime").val(associationInfoMap.STARTDATE);
